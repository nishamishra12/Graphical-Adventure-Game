...
//            false, 5, new FixedRandomizer(2));
//    for (Location l : dungeon.getLocationList()) {
//      assertTrue(dungeon.dfs(l).size() == this.dungeon.getLocationList().size());
//    }
//  }
//
//  @Test
...
//            true, 5, new FixedRandomizer(2, 3, 4));
//    for (Location l : dungeonW.getLocationList()) {
//      assertTrue(dungeonW.dfs(l).size() == this.dungeonW.getLocationList().size());
//    }
//  }
//
//  @Test
...
//            false, 5, new FixedRandomizer(2));
//
//    Map<Location, Integer> bfsLevel = dungeon.dfs(dungeon.getStartCave());
//
//    int distance = 0;
...
//    assertEquals(SmellType.HIGH_PUNGENT, d.checkSmell());
//  }
//
//  @Test
...
//    assertEquals(SmellType.LESS_PUNGENT, d.checkSmell());
//  }
//
//  @Test
...
//    assertEquals(SmellType.ODOURLESS, d.checkSmell());
//  }
//
//
//  @Test
...
//    assertTrue(dungeon.getPlayer().getHealth() > 0);
//    assertEquals(100, dungeon.getLocationList().get(2).getMonster().getHealth());
//
...
//    int count = 0;
//
//    Map<Location, Integer> monsterLevel = dungeon.dfs(dungeon.getStartCave());
